...
#define KBD_LIGHT_ROT_X_PLUS 9
#define KBD_LIGHT_ROT_X_MINUS 13
#define KBD_LIGHT_ROT_Z_MINUS 8
#define KBD_LIGHT_ROT_Z_PLUS 10
#define KBD_LIGHT_ROT_Y_MINUS 12
#define KBD_LIGHT_ROT_Y_PLUS 14
